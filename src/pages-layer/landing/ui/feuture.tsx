...
const features = [
  ...
  "LLM. A large language model analyzes and evaluates candidate responses.",
  "Rating system. We evaluate resume quality and assign ratings.",
  "Search system. We help find candidates by various criteria.",
  "We track changes in resumes and verify candidates against job requirements.",
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-2 py-8 my-12">
        ...
        <div className="flex flex-col items-start justify-center ml-auto w-full sm:w-2/4">
          <h3 className="text-3xl lg:text-4xl font-bold leading-relaxed text-black-600">
            AI-powered recruitment service
          </h3>
          <p className="my-2 text-black-500">
            We have combined modern technologies into our service
          </p>
